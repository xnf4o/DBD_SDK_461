...
struct FGameInitAnalytics : public FUniquelyIdentifiedAnalytic
{
	...
	unsigned char                                      UnknownData_D37F[0x7];                                     // 0x0089(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGameplay_PigSurvivorAnalytics : public FUniquelyIdentifiedAnalytic
{
	...
	unsigned char                                      UnknownData_TF99[0x4];                                     // 0x009C(0x0004) MISSED OFFSET (PADDING)
...
struct FGameplay_SurvivorAnalytics : public FUniquelyIdentifiedAnalytic
{
	...
	unsigned char                                      UnknownData_CCXK[0x4];                                     // 0x00F4(0x0004) MISSED OFFSET (PADDING)
...
struct FInteractionAnalytics : public FUniquelyIdentifiedAnalytic
{
	...
	unsigned char                                      UnknownData_4OOT[0x3];                                     // 0x0069(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKillerTutorialAnalytics : public FUniquelyIdentifiedAnalytic
{
	...
	unsigned char                                      UnknownData_8PI0[0x7];                                     // 0x0079(0x0007) MISSED OFFSET (PADDING)
...
struct FKrakenRequestAnalytics : public FUniquelyIdentifiedAnalytic
{
	...
	unsigned char                                      UnknownData_6YB0[0x1];                                     // 0x00B7(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5K3X[0x4];                                     // 0x00D4(0x0004) MISSED OFFSET (PADDING)
...
struct FLoadoutBaseAnalytics : public FUniquelyIdentifiedAnalytic
{
	...
	unsigned char                                      UnknownData_JJXJ[0x3];                                     // 0x00E9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMapCoordData
{
	...
	unsigned char                                      UnknownData_GDN6[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FMatchInfoAnalytics : public FUniquelyIdentifiedAnalytic
{
	...
	unsigned char                                      UnknownData_F7DF[0x3];                                     // 0x0109(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_X8BD[0x1];                                     // 0x012F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMatchmakingAnalytics : public FUniquelyIdentifiedAnalytic
{
	...
	unsigned char                                      UnknownData_ZETU[0x2];                                     // 0x007A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMatchmakingLobbyAnalytics : public FMatchmakingAnalytics
{
	...
	unsigned char                                      UnknownData_X7CM[0x4];                                     // 0x00C4(0x0004) MISSED OFFSET (PADDING)
...
struct FCrowdChoiceVoteResultAnalytics : public FUniquelyIdentifiedAnalytic
{
	...
	unsigned char                                      UnknownData_W731[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (PADDING)
...
struct FCrowdChoiceSummaryResultAnalytics : public FUniquelyIdentifiedAnalytic
{
	...
	unsigned char                                      UnknownData_BE3B[0x4];                                     // 0x009C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCrowdPlayLobbyResultsAnalytics : public FUniquelyIdentifiedAnalytic
{
	...
	unsigned char                                      UnknownData_YC66[0x4];                                     // 0x0094(0x0004) MISSED OFFSET (PADDING)
...
struct FCurrencyBalanceAnalytics : public FUniquelyIdentifiedAnalytic
{
	...
	unsigned char                                      UnknownData_UJ22[0x4];                                     // 0x007C(0x0004) MISSED OFFSET (PADDING)
...
struct FCustomizationBaseAnalytics : public FUniquelyIdentifiedAnalytic
{
	...
	unsigned char                                      UnknownData_QXIK[0x7];                                     // 0x00C9(0x0007) MISSED OFFSET (PADDING)
...
struct FDisconnectionAnalytics : public FUniquelyIdentifiedAnalytic
{
	...
	unsigned char                                      UnknownData_LQB2[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDisconnectionDetailsAnalytics : public FUniquelyIdentifiedAnalytic
{
	...
	unsigned char                                      UnknownData_1NX5[0x3];                                     // 0x008D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BA8I[0x7];                                     // 0x00A1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VEIL[0x1];                                     // 0x00BF(0x0001) MISSED OFFSET (PADDING)
...
struct FEmblemProgressionDetailsAnalytics
{
	...
	unsigned char                                      UnknownData_O8UK[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FEmblemProgressionAnalytics : public FUniquelyIdentifiedAnalytic
{
	...
	unsigned char                                      UnknownData_261J[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEndpointLatencyData
{
	...
	unsigned char                                      UnknownData_21OK[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FFallOutOfWorldAnalytics : public FUniquelyIdentifiedAnalytic
{
	...
	unsigned char                                      UnknownData_XGFK[0x4];                                     // 0x0094(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WY5X[0x4];                                     // 0x00AC(0x0004) MISSED OFFSET (PADDING)
...
struct FFrameHikeAnalytics : public FUniquelyIdentifiedAnalytic
{
	...
	unsigned char                                      UnknownData_ZP2H[0x3];                                     // 0x0075(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_O4UP[0x4];                                     // 0x0104(0x0004) MISSED OFFSET (PADDING)
...
struct FSaveGameSummaryPlayerStatsAnalytics : public FUniquelyIdentifiedAnalytic
{
	...
	unsigned char                                      UnknownData_8U2D[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDetailedScoreAnalytics : public FUniquelyIdentifiedAnalytic
{
	...
	unsigned char                                      UnknownData_QDD9[0x4];                                     // 0x00C4(0x0004) MISSED OFFSET (PADDING)
...
struct FScoreAnalytics : public FUniquelyIdentifiedAnalytic
{
	...
	unsigned char                                      UnknownData_53Y1[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (PADDING)
...
{
	DBDSharedTypes_EPlayerRole                         role;                                                      // 0x0068(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_1DAR[0x7];                                     // 0x0069(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FStadiaLivestreamAnalytics : public FUniquelyIdentifiedAnalytic
{
	...
	unsigned char                                      UnknownData_7C4Z[0x6];                                     // 0x008A(0x0006) MISSED OFFSET (PADDING)
...
struct FFrameTravelTimeAnalytics : public FUniquelyIdentifiedAnalytic
{
	...
	unsigned char                                      UnknownData_MAXP[0x4];                                     // 0x00BC(0x0004) MISSED OFFSET (PADDING)
...
struct FStadiaStreamAnalytics : public FUniquelyIdentifiedAnalytic
{
	...
	unsigned char                                      UnknownData_MW4P[0x4];                                     // 0x00C4(0x0004) MISSED OFFSET (PADDING)
...
struct FSurvivorTutorialAnalytics : public FUniquelyIdentifiedAnalytic
{
	...
	unsigned char                                      UnknownData_MN6P[0x7];                                     // 0x0091(0x0007) MISSED OFFSET (PADDING)
...
struct FMatchmakingQueueAnalytics : public FMatchmakingAnalytics
{
	...
	unsigned char                                      UnknownData_IVHD[0x3];                                     // 0x00B5(0x0003) MISSED OFFSET (PADDING)
...
struct FMatchmakingSearchCompleteAnalytics : public FUniquelyIdentifiedAnalytic
{
	...
	unsigned char                                      UnknownData_4ZBB[0x3];                                     // 0x0069(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EJFV[0x7];                                     // 0x0071(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1439[0xA0];                                    // 0x00A8(0x00A0) MISSED OFFSET (PADDING)
...
struct FMatchmakingHostCreatedAnalytics : public FUniquelyIdentifiedAnalytic
{
	...
	unsigned char                                      UnknownData_SQ2O[0x50];                                    // 0x0088(0x0050) MISSED OFFSET (PADDING)
...
struct FMatchmakingJoinCompleteAnalytics : public FUniquelyIdentifiedAnalytic
{
	...
	unsigned char                                      UnknownData_Y7PX[0x4];                                     // 0x007C(0x0004) MISSED OFFSET (PADDING)
...
struct FMatchmakingApproveLoginAnalytics : public FUniquelyIdentifiedAnalytic
{
	...
	unsigned char                                      UnknownData_FTU7[0x3];                                     // 0x006D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FWaitTimeAnalytics : public FUniquelyIdentifiedAnalytic
{
	...
	unsigned char                                      UnknownData_2AJ4[0x2];                                     // 0x00D2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QQ9R[0x4];                                     // 0x00E4(0x0004) MISSED OFFSET (PADDING)
...
struct FQueueAnalytics : public FUniquelyIdentifiedAnalytic
{
	...
	unsigned char                                      UnknownData_HVFP[0x3];                                     // 0x0099(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMenuFlowAnalytics : public FUniquelyIdentifiedAnalytic
{
	...
	unsigned char                                      UnknownData_PBWH[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPostGame_KillerAnalytics : public FPostGameAnalyticsBase
{
	...
	unsigned char                                      UnknownData_HLW3[0x4];                                     // 0x00E4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IY3S[0x1];                                     // 0x0107(0x0001) MISSED OFFSET (PADDING)
...
struct FPostGame_SurvivorAnalytics : public FPostGameAnalyticsBase
{
	...
	unsigned char                                      UnknownData_7RPL[0x3];                                     // 0x00C9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ELYI[0x6];                                     // 0x00D2(0x0006) MISSED OFFSET (PADDING)
...
struct FProceduralGenerationAnalytics : public FUniquelyIdentifiedAnalytic
{
	...
	unsigned char                                      UnknownData_IYBM[0x4];                                     // 0x013C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RAIU[0x3];                                     // 0x0175(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LRQK[0x4];                                     // 0x017C(0x0004) MISSED OFFSET (PADDING)
...
struct FReportAnalytics : public FUniquelyIdentifiedAnalytic
{
	...
	unsigned char                                      UnknownData_CWQ4[0x6];                                     // 0x00AA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRTMAnalytics : public FUniquelyIdentifiedAnalytic
{
	...
	unsigned char                                      UnknownData_7BHT[0x4];                                     // 0x007C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FArchiveVignetteVideoAnalytics : public FUniquelyIdentifiedAnalytic
{
	...
	unsigned char                                      UnknownData_FQIU[0x7];                                     // 0x00B1(0x0007) MISSED OFFSET (PADDING)
...
struct FArchiveVignetteEntryAnalytics : public FUniquelyIdentifiedAnalytic
{
	...
	unsigned char                                      UnknownData_4CQ8[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KHOY[0x4];                                     // 0x00AC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBotReplacementAnalytics : public FUniquelyIdentifiedAnalytic
{
	...
	unsigned char                                      UnknownData_VYOH[0x3];                                     // 0x0089(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_S471[0x7];                                     // 0x00B1(0x0007) MISSED OFFSET (PADDING)
...
struct FGameplay_ChaseAnalytics : public FUniquelyIdentifiedAnalytic
{
	...
	unsigned char                                      UnknownData_H0H8[0x7];                                     // 0x0079(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_I8S8[0x4];                                     // 0x00FC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5CJU[0x4];                                     // 0x0124(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
