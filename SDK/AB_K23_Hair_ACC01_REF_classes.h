...
// AnimBlueprintGeneratedClass AB_K23_Hair_ACC01_REF.AB_K23_Hair_ACC01_REF_C
...
public:
	...
	unsigned char                                      UnknownData_TAUN[0x8];                                     // 0x10D8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("AnimBlueprintGeneratedClass AB_K23_Hair_ACC01_REF.AB_K23_Hair_ACC01_REF_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_AB_K23_Hair_ACC01_REF(int EntryPoint);
};
