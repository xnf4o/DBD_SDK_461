...
{
public:
	unsigned char                                      UnknownData_M26H[0x7];                                     // 0x0259(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("BlueprintGeneratedClass BP_Effect_K21_Head01_CV01.BP_Effect_K21_Head01_CV01_C");
		return ptr;
	}
