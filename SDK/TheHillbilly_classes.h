...
{
public:
	unsigned char                                      UnknownData_LQJC[0x18];                                    // 0x00B8(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ROBI[0x2C];                                    // 0x00D4(0x002C) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_EGTU[0x58];                                    // 0x02E0(0x0058) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_WZ1U[0x38];                                    // 0x00F0(0x0038) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_3X9M[0x8];                                     // 0x0628(0x0008) Fix Super Size
	unsigned char                                      UnknownData_AU3I[0x28];                                    // 0x0630(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1VGE[0x4];                                     // 0x0664(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_82S2[0x10];                                    // 0x0680(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_XJOB[0x10];                                    // 0x0218(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_NEBA[0x80];                                    // 0x0100(0x0080) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_3RME[0x8];                                     // 0x05A8(0x0008) Fix Super Size
...
public:
	...
	unsigned char                                      UnknownData_XZV0[0x118];                                   // 0x00C8(0x0118) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_5XTZ[0x50];                                    // 0x0690(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_ED96[0x20];                                    // 0x05C0(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_2NHJ[0x28];                                    // 0x0228(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_0C8P[0x5B];                                    // 0x00ED(0x005B) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_DI3R[0x33];                                    // 0x023D(0x0033) MISSED OFFSET (PADDING)
