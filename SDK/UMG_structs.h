...
{
	unsigned char                                      UnknownData_W6AH[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (PADDING)
...
struct FAnimationEventBinding
{
	...
	unsigned char                                      UnknownData_UL2M[0x4];                                     // 0x0008(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_SHOZ[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IQWM[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FNamedSlotBinding
{
	...
	unsigned char                                      UnknownData_LYF2[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieScene2DTransformSectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	unsigned char                                      UnknownData_1VRV[0x3];                                     // 0x04B9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneMarginSectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	unsigned char                                      UnknownData_O6WH[0x7];                                     // 0x02D9(0x0007) MISSED OFFSET (PADDING)
...
struct FSlateChildSize
{
	...
	unsigned char                                      UnknownData_7EZ5[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FUserWidgetPool
{
	...
	unsigned char                                      UnknownData_05JL[0x60];                                    // 0x0020(0x0060) MISSED OFFSET (PADDING)
...
struct FWidgetAnimationBinding
{
	...
	unsigned char                                      UnknownData_FR4V[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (PADDING)
...
struct FBlueprintWidgetAnimationDelegateBinding
{
	...
	unsigned char                                      UnknownData_2KLB[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDelegateRuntimeBinding
{
	...
	unsigned char                                      UnknownData_AEIM[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_LEYP[0x10];                                    // 0x00A8(0x0010) MISSED OFFSET (PADDING)
...
struct FWidgetNavigationData
{
	...
	unsigned char                                      UnknownData_CZ75[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XP2P[0x4];                                     // 0x0018(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FEventReply
{
	unsigned char                                      UnknownData_5VB0[0xC0];                                    // 0x0000(0x00C0) MISSED OFFSET (PADDING)
