...
{
public:
	unsigned char                                      UnknownData_SLTK[0x10];                                    // 0x0108(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TG6K[0x10];                                    // 0x0120(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_UXBY[0x30];                                    // 0x0108(0x0030) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_VYH0[0x40];                                    // 0x0108(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AGKZ[0x18];                                    // 0x0150(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_OSBW[0x20];                                    // 0x0108(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HBLK[0x8];                                     // 0x0138(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_18RG[0x10];                                    // 0x0108(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TMap<class UcamperPlayer*, int>                    _remainingSurvivorHookStates;                              // 0x0118(0x0050) (Transient, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_R654[0x8];                                     // 0x0168(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_UXXD[0x60];                                    // 0x0108(0x0060) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_WUS9[0x50];                                    // 0x0108(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_1ER4[0x88];                                    // 0x0108(0x0088) MISSED OFFSET (PADDING)
