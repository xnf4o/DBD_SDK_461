...
public:
	...
	unsigned char                                      UnknownData_5PV6[0x8];                                     // 0x00E8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_Y0A6[0x8];                                     // 0x00D8(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_CVC4[0x4];                                     // 0x00E4(0x0004) MISSED OFFSET (PADDING)
