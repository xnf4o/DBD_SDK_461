...
public:
	...
	unsigned char                                      UnknownData_H3U1[0x14];                                    // 0x00C0(0x0014) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_STTZ[0x3];                                     // 0x00E5(0x0003) MISSED OFFSET (PADDING)
