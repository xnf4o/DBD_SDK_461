...
public:
	...
	unsigned char                                      UnknownData_235P[0x8];                                     // 0x0838(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("AnimBlueprintGeneratedClass AB_GS_Necklace_ACC01.AB_GS_Necklace_ACC01_C");
		return ptr;
	}
