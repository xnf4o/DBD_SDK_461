...
// AnimBlueprintGeneratedClass AB_GK_Hairs_ACC01.AB_GK_Hairs_ACC01_C
...
public:
	...
	unsigned char                                      UnknownData_YBCL[0x8];                                     // 0x10D8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FAnimNode_UseCachedPose                     AnimGraphNode_UseCachedPose_2;                             // 0x1E00(0x0030)
	struct FAnimNode_ConvertLocalToComponentSpace      AnimGraphNode_LocalToComponentSpace;                       // 0x1E30(0x0020)
	struct FAnimNode_ConvertComponentToLocalSpace      AnimGraphNode_ComponentToLocalSpace;                       // 0x1E50(0x0020)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("AnimBlueprintGeneratedClass AB_GK_Hairs_ACC01.AB_GK_Hairs_ACC01_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_AB_GK_Hairs_ACC01(int EntryPoint);
};
