...
public:
	...
	unsigned char                                      UnknownData_IFG4[0x8];                                     // 0x2708(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SMAF[0x6];                                     // 0x5C1A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
