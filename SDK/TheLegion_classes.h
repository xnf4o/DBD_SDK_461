...
{
public:
	unsigned char                                      UnknownData_GZWR[0x10];                                    // 0x02E0(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_K1FJ[0x38];                                    // 0x00B8(0x0038) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_9GAW[0x58];                                    // 0x00B8(0x0058) MISSED OFFSET (PADDING)
