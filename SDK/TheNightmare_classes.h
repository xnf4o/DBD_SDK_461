...
{
public:
	unsigned char                                      UnknownData_7J47[0x8];                                     // 0x0628(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_PANN[0x40];                                    // 0x0638(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1IC1[0x8];                                     // 0x0688(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9SI5[0x2];                                     // 0x06C2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HNT1[0x8];                                     // 0x06E8(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_NQ2A[0x1F];                                    // 0x04F1(0x001F) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_CLXP[0x8];                                     // 0x05A8(0x0008) Fix Super Size
...
public:
	...
	unsigned char                                      UnknownData_93SQ[0x8];                                     // 0x0510(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_IOIZ[0x10];                                    // 0x00B8(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_GRHE[0x4];                                     // 0x0628(0x0004) Fix Super Size
	...
	unsigned char                                      UnknownData_NDGV[0xC];                                     // 0x0634(0x000C) MISSED OFFSET (PADDING)
