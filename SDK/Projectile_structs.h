...
{
	unsigned char                                      UnknownData_FH9Y[0x14];                                    // 0x0000(0x0014) MISSED OFFSET (PADDING)
...
struct FimpactInfo
{
	...
	unsigned char                                      UnknownData_2WHI[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VOQO[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
