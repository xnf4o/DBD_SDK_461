...
{
public:
	unsigned char                                      UnknownData_DC6P[0x8];                                     // 0x0628(0x0008) Fix Super Size
	unsigned char                                      UnknownData_U3MU[0x14];                                    // 0x0630(0x0014) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WHQX[0xB];                                     // 0x0645(0x000B) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_4M7D[0x4];                                     // 0x0504(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_A7PR[0x8];                                     // 0x0538(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_5P9R[0x3];                                     // 0x0635(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Z3D7[0x7];                                     // 0x0641(0x0007) Fix Super Size
...
public:
	...
	unsigned char                                      UnknownData_FJXX[0x4];                                     // 0x0654(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KUZV[0xC];                                     // 0x0664(0x000C) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_FYP8[0x8];                                     // 0x0628(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_SBMQ[0x8];                                     // 0x0638(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_CRZD[0x8];                                     // 0x0648(0x0008) Fix Super Size
...
public:
	...
	unsigned char                                      UnknownData_RV4W[0x8];                                     // 0x0688(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_2MDG[0xF];                                     // 0x0281(0x000F) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_SA0Q[0x4];                                     // 0x0628(0x0004) Fix Super Size
	...
	unsigned char                                      UnknownData_90AH[0x60];                                    // 0x0658(0x0060) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YAUC[0x8];                                     // 0x06C8(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_Y8OK[0x4];                                     // 0x0634(0x0004) Fix Super Size
...
{
public:
	unsigned char                                      UnknownData_BFR3[0x8];                                     // 0x0628(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_SYAM[0x18];                                    // 0x0638(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_B58E[0x10];                                    // 0x0500(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_35YC[0x10];                                    // 0x0520(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_L9Y9[0x10];                                    // 0x0530(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_UN4F[0x8];                                     // 0x0628(0x0008) Fix Super Size
...
{
public:
	unsigned char                                      UnknownData_4NRA[0x10];                                    // 0x0510(0x0010) MISSED OFFSET (PADDING)
