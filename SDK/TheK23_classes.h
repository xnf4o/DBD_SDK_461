...
public:
	...
	unsigned char                                      UnknownData_Q02C[0x8];                                     // 0x0528(0x0008) MISSED OFFSET (PADDING)
...
// 0x00B0 (FullSize[0x04D0] - InheritedSize[0x0420])
class UThrowingKnives : public Ucollectable
{
public:
	unsigned char                                      UnknownData_04NW[0x40];                                    // 0x0420(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	class UKnivesProvider*                             _knivesProvider;                                           // 0x0480(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UKnivesLauncher*                             _knivesLauncher;                                           // 0x0488(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UClass*                                      _lacerationComponentClass;                                 // 0x0490(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UClass*                                      _reloadInteractionClass;                                   // 0x0498(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UClass*                                      _closetReloadActor;                                        // 0x04A0(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                              _minimumTimeBetweenBroadcast;                              // 0x04A8(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_OOO9[0x24];                                    // 0x04AC(0x0024) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_MDLN[0x10];                                    // 0x0500(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_IVSO[0x4];                                     // 0x05A8(0x0004) Fix Super Size
	...
	unsigned char                                      UnknownData_HL4S[0x2];                                     // 0x05B2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_K9HE[0x2];                                     // 0x05CA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TDNN[0x3];                                     // 0x05D1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CLFI[0x38];                                    // 0x05D8(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_W40H[0x8];                                     // 0x0618(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_LKVM[0x4];                                     // 0x0218(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UWKM[0x3];                                     // 0x021D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZT11[0x4];                                     // 0x022C(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_XIDT[0xD];                                     // 0x00BB(0x000D) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_M1L0[0x18];                                    // 0x01D0(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_RL8B[0x4];                                     // 0x02B4(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_1T01[0x8];                                     // 0x0500(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7RNF[0x8];                                     // 0x0578(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_I8JY[0xC];                                     // 0x0354(0x000C) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_ABUY[0x1C];                                    // 0x00B8(0x001C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZCT8[0x48];                                    // 0x0220(0x0048) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_TIHD[0x8];                                     // 0x0628(0x0008) Fix Super Size
	unsigned char                                      UnknownData_60WS[0x40];                                    // 0x0630(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	bool                                               _isSuperModeThrow;                                         // 0x0674(0x0001) (Net, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_OOEY[0x4B];                                    // 0x0675(0x004B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RBKS[0x8];                                     // 0x0AB8(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_5OCZ[0x4];                                     // 0x03B4(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_47BN[0x10];                                    // 0x0300(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class TheK23.KnifeRack");
		return ptr;
	}



	void OnReloadMontageStarted(float actionSpeedMultiplier, class UdbdPlayer* player);
	void OnReloadEnded(class UdbdPlayer* player);
};
...
public:
	...
	unsigned char                                      UnknownData_JO7E[0x8];                                     // 0x0238(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	bool                                               _isInSuperModeThrow;                                       // 0x0240(0x0001) (Net, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_NDFW[0x7];                                     // 0x0241(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_4IP5[0x8];                                     // 0x00F0(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_CWB9[0x38];                                    // 0x00B8(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QR2E[0xC];                                     // 0x00F4(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RB4V[0x28];                                    // 0x0108(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_4R18[0x4];                                     // 0x00EC(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_ROA7[0x10];                                    // 0x0370(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_UJS0[0x8];                                     // 0x0508(0x0008) Fix Super Size
...
public:
	...
	unsigned char                                      UnknownData_D0S3[0xB8];                                    // 0x03B0(0x00B8) MISSED OFFSET (PADDING)
