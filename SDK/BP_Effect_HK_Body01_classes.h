...
{
public:
	unsigned char                                      UnknownData_S4MK[0x7];                                     // 0x0259(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("BlueprintGeneratedClass BP_Effect_HK_Body01.BP_Effect_HK_Body01_C");
		return ptr;
	}
