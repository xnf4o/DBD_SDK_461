...
public:
	...
	unsigned char                                      UnknownData_Y14Z[0x8];                                     // 0x1998(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("AnimBlueprintGeneratedClass AB_US_Bag_ACC006.AB_US_Bag_ACC006_C");
		return ptr;
	}
