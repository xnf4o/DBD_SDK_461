...
// AnimBlueprintGeneratedClass AB_S24_necklace_ACC01_REF.AB_S24_necklace_ACC01_REF_C
...
public:
	...
	struct FAnimNode_ConvertLocalToComponentSpace      AnimGraphNode_LocalToComponentSpace_2;                     // 0x1080(0x0020)
	struct FAnimNode_StateResult                       AnimGraphNode_StateResult_3;                               // 0x10A0(0x0038)
	unsigned char                                      UnknownData_JTKD[0x8];                                     // 0x10D8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FAnimNode_ConvertLocalToComponentSpace      AnimGraphNode_LocalToComponentSpace;                       // 0x1E20(0x0020)
	struct FAnimNode_UseCachedPose                     AnimGraphNode_UseCachedPose_2;                             // 0x1E40(0x0030)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("AnimBlueprintGeneratedClass AB_S24_necklace_ACC01_REF.AB_S24_necklace_ACC01_REF_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_AB_S24_necklace_ACC01_REF(int EntryPoint);
};
