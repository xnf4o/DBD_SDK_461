...
void UGameMapsSettings::SetSkipAssigningGamepadToPlayer1(bool bSkipFirstPlayer)
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function EngineSettings.GameMapsSettings.SetSkipAssigningGamepadToPlayer1");
...
bool UGameMapsSettings::GetSkipAssigningGamepadToPlayer1()
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function EngineSettings.GameMapsSettings.GetSkipAssigningGamepadToPlayer1");
...
class UGameMapsSettings* UGameMapsSettings::STATIC_GetGameMapsSettings()
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function EngineSettings.GameMapsSettings.GetGameMapsSettings");
