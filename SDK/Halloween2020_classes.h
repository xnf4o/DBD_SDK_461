...
public:
	...
	unsigned char                                      UnknownData_ER76[0x40];                                    // 0x0230(0x0040) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_VT21[0x14];                                    // 0x050C(0x0014) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_CBX8[0x8];                                     // 0x0508(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_FZS1[0x58];                                    // 0x0548(0x0058) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_X7TW[0x8];                                     // 0x02E0(0x0008) MISSED OFFSET (PADDING)
