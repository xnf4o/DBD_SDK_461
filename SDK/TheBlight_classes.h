...
{
public:
	unsigned char                                      UnknownData_AMMF[0x8];                                     // 0x0628(0x0008) Fix Super Size
...
public:
	...
	unsigned char                                      UnknownData_YOXR[0xC];                                     // 0x021C(0x000C) MISSED OFFSET (PADDING)
...
public:
	float                                              _speedIncreasePerDash;                                     // 0x0218(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_YFZD[0xC];                                     // 0x021C(0x000C) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_NIHL[0x3];                                     // 0x021D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5HF5[0x20];                                    // 0x0260(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_DKGL[0x3];                                     // 0x05B1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_S4P7[0x4];                                     // 0x05BC(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_7CAS[0x40];                                    // 0x04F8(0x0040) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_T4WW[0x8];                                     // 0x0230(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_AEGB[0x10];                                    // 0x0030(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8KLM[0xF];                                     // 0x0129(0x000F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_36QA[0x7];                                     // 0x0139(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_S4HB[0x4];                                     // 0x0144(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GRLL[0x10];                                    // 0x0170(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_8KSD[0x20];                                    // 0x0198(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_4L7X[0x28];                                    // 0x01B8(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_F2V5[0x18];                                    // 0x00B8(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Q9GE[0x18];                                    // 0x0198(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AUU0[0x7];                                     // 0x01D1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_A3UY[0x38];                                    // 0x0258(0x0038) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_ZXIZ[0x3];                                     // 0x0171(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_PL3L[0x7];                                     // 0x01E9(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_MCG5[0x7];                                     // 0x01B9(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_PFDK[0x7];                                     // 0x0361(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1D93[0x18];                                    // 0x0370(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_ZH7J[0xB];                                     // 0x0375(0x000B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_BSF6[0xB];                                     // 0x03CD(0x000B) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_4LVE[0x58];                                    // 0x03A8(0x0058) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
