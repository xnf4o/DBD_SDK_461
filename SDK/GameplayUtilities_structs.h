...
{
	unsigned char                                      UnknownData_TLER[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FAuthorityDiscernedCharacter
{
	...
	unsigned char                                      UnknownData_F0NC[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
...
{
	class Ucharacter*                                  _character;                                                // 0x0000(0x0008) (ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_L2ZD[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
struct FHitValidatorInstigatorParams
{
	...
	unsigned char                                      UnknownData_VPCL[0x48];                                    // 0x0008(0x0048) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_E379[0x8];                                     // 0x0058(0x0008) MISSED OFFSET (PADDING)
...
struct FHitValidatorTargetParams
{
	...
	unsigned char                                      UnknownData_VTRF[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FHitValidationReport
{
	...
	unsigned char                                      UnknownData_UC2O[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IH3D[0xE];                                     // 0x00A2(0x000E) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CWF5[0x2];                                     // 0x00FE(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
