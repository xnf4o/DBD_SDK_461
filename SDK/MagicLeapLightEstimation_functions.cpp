...
bool UMagicLeapLightEstimationFunctionLibrary::STATIC_IsTrackerValid()
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function MagicLeapLightEstimation.MagicLeapLightEstimationFunctionLibrary.IsTrackerValid");
...
bool UMagicLeapLightEstimationFunctionLibrary::STATIC_GetColorTemperatureState(struct FMagicLeapLightEstimationColorTemperatureState* ColorTemperatureState)
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function MagicLeapLightEstimation.MagicLeapLightEstimationFunctionLibrary.GetColorTemperatureState");
...
bool UMagicLeapLightEstimationFunctionLibrary::STATIC_GetAmbientGlobalState(struct FMagicLeapLightEstimationAmbientGlobalState* GlobalAmbientState)
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function MagicLeapLightEstimation.MagicLeapLightEstimationFunctionLibrary.GetAmbientGlobalState");
...
void UMagicLeapLightEstimationFunctionLibrary::STATIC_DestroyTracker()
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function MagicLeapLightEstimation.MagicLeapLightEstimationFunctionLibrary.DestroyTracker");
...
bool UMagicLeapLightEstimationFunctionLibrary::STATIC_CreateTracker()
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function MagicLeapLightEstimation.MagicLeapLightEstimationFunctionLibrary.CreateTracker");
