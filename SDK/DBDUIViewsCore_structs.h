...
struct FDBDTextDockingProperties
{
	...
	unsigned char                                      UnknownData_4NJY[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GOU8[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DUAN[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInputPromptDataRow : public FTableRowBase
{
	...
	unsigned char                                      UnknownData_PV9A[0x7];                                     // 0x0071(0x0007) MISSED OFFSET (PADDING)
