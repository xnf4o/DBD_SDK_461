...
{
public:
	unsigned char                                      UnknownData_GPWD[0x7];                                     // 0x0649(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("BlueprintGeneratedClass BP_Menu_CamperMale05.BP_Menu_CamperMale05_C");
		return ptr;
	}
