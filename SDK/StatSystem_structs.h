...
struct FStatModifier
{
	...
	unsigned char                                      UnknownData_FSFM[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GJKY[0x17];                                    // 0x0011(0x0017) MISSED OFFSET (PADDING)
...
struct FBaseStat
{
	unsigned char                                      UnknownData_U71G[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNonTunableStat : public FBaseStat
{
	...
	unsigned char                                      UnknownData_CPG0[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FStatProperty : public FBaseStat
{
	...
	unsigned char                                      UnknownData_N71S[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
