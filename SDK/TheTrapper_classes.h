...
public:
	...
	unsigned char                                      UnknownData_JMZI[0x3];                                     // 0x0461(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5D2E[0x4];                                     // 0x046C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4YDN[0x18];                                    // 0x04A8(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_N8Q7[0xB];                                     // 0x0285(0x000B) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_ZNUF[0x8];                                     // 0x02A8(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_EVOA[0x1];                                     // 0x06D8(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KL5F[0x6];                                     // 0x06DA(0x0006) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_GD28[0x8];                                     // 0x05A8(0x0008) Fix Super Size
...
{
public:
	unsigned char                                      UnknownData_80ZU[0x8];                                     // 0x0628(0x0008) Fix Super Size
