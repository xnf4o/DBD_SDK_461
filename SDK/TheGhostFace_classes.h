...
{
public:
	unsigned char                                      UnknownData_PGG1[0x38];                                    // 0x00B8(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FGhostKillerAnalytics                       _ghostKillerAnalytics;                                     // 0x00F0(0x00B0) (Net, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_MGM3[0x28];                                    // 0x01A0(0x0028) MISSED OFFSET (PADDING)
