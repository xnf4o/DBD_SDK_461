...
struct FAIGoalWeight
{
	...
	unsigned char                                      UnknownData_2QNQ[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRelevantNodeMemory
{
	...
	unsigned char                                      UnknownData_Q9SE[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
struct FMindFocusObjectEntry
{
	...
	unsigned char                                      UnknownData_9P8N[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TMap<struct FName, float>                          CooldownMap;                                               // 0x0018(0x0050) (NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_S2W1[0x10];                                    // 0x0068(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_IRQG[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
...
struct FNavLinkInteractPlayerSetup
{
	...
	unsigned char                                      UnknownData_UT78[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_VWTR[0x14];                                    // 0x0000(0x0014) MISSED OFFSET (PADDING)
