...
struct FFriendData
{
	unsigned char                                      UnknownData_YSL0[0x60];                                    // 0x0000(0x0060) MISSED OFFSET (PADDING)
...
struct FRarityMaterialData : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_26F1[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
