...
struct FAssetData
{
	...
	unsigned char                                      UnknownData_ONO9[0x2C];                                    // 0x003C(0x002C) MISSED OFFSET (PADDING)
...
struct FTagAndValue
{
	...
	unsigned char                                      UnknownData_M5QY[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FARFilter
{
	...
	unsigned char                                      UnknownData_UWTU[0x50];                                    // 0x0040(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0ZTK[0x5];                                     // 0x00E3(0x0005) MISSED OFFSET (PADDING)
...
struct FAssetBundleEntry
{
	...
	unsigned char                                      UnknownData_SNU3[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
