...
{
	unsigned char                                      UnknownData_5LMD[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VXKX[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
