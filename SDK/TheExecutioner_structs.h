...
struct FAgonyDisplayFxEvent
{
	...
	unsigned char                                      UnknownData_4HL3[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_1CLH[0x60];                                    // 0x0000(0x0060) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_6BPE[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LU0U[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_U9E7[0xC];                                     // 0x0034(0x000C) MISSED OFFSET (PADDING)
...
struct FSpawnedAttackPoint
{
	...
	unsigned char                                      UnknownData_OYQO[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
struct FSpawnedTormentTrailPoint
{
	...
	unsigned char                                      UnknownData_JDJE[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
