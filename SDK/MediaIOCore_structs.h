...
struct FMediaIOMode
{
	...
	unsigned char                                      UnknownData_IC44[0x3];                                     // 0x0010(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FMediaIOConnection
{
	...
	unsigned char                                      UnknownData_21GD[0x3];                                     // 0x001C(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_TTG5[0x3];                                     // 0x0020(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FMediaIOConfiguration
{
	...
	unsigned char                                      UnknownData_CHRW[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMediaIOInputConfiguration
{
	...
	unsigned char                                      UnknownData_S1CR[0x3];                                     // 0x0044(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FMediaCaptureOptions
{
	...
	unsigned char                                      UnknownData_TAK7[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FYHM[0x2];                                     // 0x000E(0x0002) MISSED OFFSET (PADDING)
...
struct FMediaIOOutputConfiguration
{
	...
	unsigned char                                      UnknownData_OJVN[0x3];                                     // 0x0044(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	int                                                KeyPortIdentifier;                                         // 0x0048(0x0004) (Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_4ZFP[0x3];                                     // 0x004C(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
