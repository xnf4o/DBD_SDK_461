...
struct UBP_Menu_CamperMale07_C_ReceiveBeginPlay_Params
{
};

// Function BP_Menu_CamperMale07.BP_Menu_CamperMale07_C.ReceiveTick
struct UBP_Menu_CamperMale07_C_ReceiveTick_Params
{
	float                                              deltaSeconds;                                              // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function BP_Menu_CamperMale07.BP_Menu_CamperMale07_C.ExecuteUbergraph_BP_Menu_CamperMale07
struct UBP_Menu_CamperMale07_C_ExecuteUbergraph_BP_Menu_CamperMale07_Params
{
