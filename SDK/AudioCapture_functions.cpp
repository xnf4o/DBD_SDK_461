...
void UAudioCapture::StopCapturingAudio()
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function AudioCapture.AudioCapture.StopCapturingAudio");
...
void UAudioCapture::StartCapturingAudio()
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function AudioCapture.AudioCapture.StartCapturingAudio");
...
bool UAudioCapture::IsCapturingAudio()
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function AudioCapture.AudioCapture.IsCapturingAudio");
...
bool UAudioCapture::GetAudioCaptureDeviceInfo(struct FAudioCaptureDeviceInfo* OutInfo)
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function AudioCapture.AudioCapture.GetAudioCaptureDeviceInfo");
...
class UAudioCapture* UAudioCaptureFunctionLibrary::STATIC_CreateAudioCapture()
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function AudioCapture.AudioCaptureFunctionLibrary.CreateAudioCapture");
