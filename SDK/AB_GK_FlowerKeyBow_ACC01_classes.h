...
// AnimBlueprintGeneratedClass AB_GK_FlowerKeyBow_ACC01.AB_GK_FlowerKeyBow_ACC01_C
...
public:
	...
	unsigned char                                      UnknownData_C4J6[0x8];                                     // 0x1538(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FAnimNode_ConvertLocalToComponentSpace      AnimGraphNode_LocalToComponentSpace;                       // 0x26F0(0x0020)
	struct FAnimNode_ConvertComponentToLocalSpace      AnimGraphNode_ComponentToLocalSpace;                       // 0x2710(0x0020)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("AnimBlueprintGeneratedClass AB_GK_FlowerKeyBow_ACC01.AB_GK_FlowerKeyBow_ACC01_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_AB_GK_FlowerKeyBow_ACC01(int EntryPoint);
};
