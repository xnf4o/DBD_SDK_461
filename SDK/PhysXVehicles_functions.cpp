...
void UWheeledVehicleMovementComponent::SetUseAutoGears(bool bUseAuto)
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function PhysXVehicles.WheeledVehicleMovementComponent.SetUseAutoGears");
...
void UWheeledVehicleMovementComponent::SetThrottleInput(float Throttle)
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function PhysXVehicles.WheeledVehicleMovementComponent.SetThrottleInput");
...
void UWheeledVehicleMovementComponent::SetTargetGear(int GearNum, bool bImmediate)
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function PhysXVehicles.WheeledVehicleMovementComponent.SetTargetGear");
...
void UWheeledVehicleMovementComponent::SetSteeringInput(float Steering)
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function PhysXVehicles.WheeledVehicleMovementComponent.SetSteeringInput");
...
void UWheeledVehicleMovementComponent::SetHandbrakeInput(bool bNewHandbrake)
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function PhysXVehicles.WheeledVehicleMovementComponent.SetHandbrakeInput");
...
void UWheeledVehicleMovementComponent::SetGroupsToIgnoreMask(const struct FNavAvoidanceMask& GroupMask)
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function PhysXVehicles.WheeledVehicleMovementComponent.SetGroupsToIgnoreMask");
...
void UWheeledVehicleMovementComponent::SetGroupsToIgnore(int GroupFlags)
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function PhysXVehicles.WheeledVehicleMovementComponent.SetGroupsToIgnore");
...
void UWheeledVehicleMovementComponent::SetGroupsToAvoidMask(const struct FNavAvoidanceMask& GroupMask)
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function PhysXVehicles.WheeledVehicleMovementComponent.SetGroupsToAvoidMask");
...
void UWheeledVehicleMovementComponent::SetGroupsToAvoid(int GroupFlags)
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function PhysXVehicles.WheeledVehicleMovementComponent.SetGroupsToAvoid");
...
void UWheeledVehicleMovementComponent::SetGearUp(bool bNewGearUp)
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function PhysXVehicles.WheeledVehicleMovementComponent.SetGearUp");
...
void UWheeledVehicleMovementComponent::SetGearDown(bool bNewGearDown)
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function PhysXVehicles.WheeledVehicleMovementComponent.SetGearDown");
...
void UWheeledVehicleMovementComponent::SetBrakeInput(float Brake)
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function PhysXVehicles.WheeledVehicleMovementComponent.SetBrakeInput");
...
void UWheeledVehicleMovementComponent::SetAvoidanceGroupMask(const struct FNavAvoidanceMask& GroupMask)
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function PhysXVehicles.WheeledVehicleMovementComponent.SetAvoidanceGroupMask");
...
void UWheeledVehicleMovementComponent::SetAvoidanceGroup(int GroupFlags)
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function PhysXVehicles.WheeledVehicleMovementComponent.SetAvoidanceGroup");
...
void UWheeledVehicleMovementComponent::SetAvoidanceEnabled(bool bEnable)
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function PhysXVehicles.WheeledVehicleMovementComponent.SetAvoidanceEnabled");
...
void UWheeledVehicleMovementComponent::ServerUpdateState(float InSteeringInput, float InThrottleInput, float InBrakeInput, float InHandbrakeInput, int CurrentGear)
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function PhysXVehicles.WheeledVehicleMovementComponent.ServerUpdateState");
...
bool UWheeledVehicleMovementComponent::GetUseAutoGears()
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function PhysXVehicles.WheeledVehicleMovementComponent.GetUseAutoGears");
...
int UWheeledVehicleMovementComponent::GetTargetGear()
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function PhysXVehicles.WheeledVehicleMovementComponent.GetTargetGear");
...
float UWheeledVehicleMovementComponent::GetForwardSpeed()
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function PhysXVehicles.WheeledVehicleMovementComponent.GetForwardSpeed");
...
float UWheeledVehicleMovementComponent::GetEngineRotationSpeed()
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function PhysXVehicles.WheeledVehicleMovementComponent.GetEngineRotationSpeed");
...
float UWheeledVehicleMovementComponent::GetEngineMaxRotationSpeed()
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function PhysXVehicles.WheeledVehicleMovementComponent.GetEngineMaxRotationSpeed");
...
int UWheeledVehicleMovementComponent::GetCurrentGear()
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function PhysXVehicles.WheeledVehicleMovementComponent.GetCurrentGear");
...
void USimpleWheeledVehicleMovementComponent::SetSteerAngle(float SteerAngle, int WheelIndex)
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function PhysXVehicles.SimpleWheeledVehicleMovementComponent.SetSteerAngle");
...
void USimpleWheeledVehicleMovementComponent::SetDriveTorque(float DriveTorque, int WheelIndex)
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function PhysXVehicles.SimpleWheeledVehicleMovementComponent.SetDriveTorque");
...
void USimpleWheeledVehicleMovementComponent::SetBrakeTorque(float BrakeTorque, int WheelIndex)
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function PhysXVehicles.SimpleWheeledVehicleMovementComponent.SetBrakeTorque");
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// class UWheeledVehicle*         ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
class UWheeledVehicle* UVehicleAnimInstance::GetVehicle()
{
	static auto fn = nullptr;
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function PhysXVehicles.VehicleAnimInstance.GetVehicle");
...
bool UVehicleWheel::IsInAir()
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function PhysXVehicles.VehicleWheel.IsInAir");
...
float UVehicleWheel::GetSuspensionOffset()
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function PhysXVehicles.VehicleWheel.GetSuspensionOffset");
...
float UVehicleWheel::GetSteerAngle()
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function PhysXVehicles.VehicleWheel.GetSteerAngle");
...
float UVehicleWheel::GetRotationAngle()
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function PhysXVehicles.VehicleWheel.GetRotationAngle");
