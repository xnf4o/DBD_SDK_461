...
public:
	...
	unsigned char                                      UnknownData_RGOJ[0x7];                                     // 0x0231(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_O06V[0x8];                                     // 0x0040(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_JMIL[0x8];                                     // 0x0040(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_T14U[0x10];                                    // 0x0030(0x0010) MISSED OFFSET (PADDING)
