...
{
public:
	unsigned char                                      UnknownData_THPZ[0x20];                                    // 0x00B8(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_6906[0x4];                                     // 0x00C4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_3E7S[0x1E];                                    // 0x00DA(0x001E) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_Z0X1[0x30];                                    // 0x0100(0x0030) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_5ITO[0x18];                                    // 0x0100(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_YZYV[0x8];                                     // 0x0100(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_YGHK[0x7];                                     // 0x00B9(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_CLUJ[0x27];                                    // 0x00B9(0x0027) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_FZJP[0x38];                                    // 0x0100(0x0038) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_4F7K[0x10];                                    // 0x00B8(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_XBAO[0x40];                                    // 0x0100(0x0040) MISSED OFFSET (PADDING)
