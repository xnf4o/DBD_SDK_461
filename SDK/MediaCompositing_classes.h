...
public:
	...
	unsigned char                                      UnknownData_402R[0x7];                                     // 0x00F1(0x0007) MISSED OFFSET (PADDING)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class MediaCompositing.MovieSceneMediaPlayerPropertySection");
		return ptr;
	}
...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class MediaCompositing.MovieSceneMediaPlayerPropertyTrack");
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_KA4C[0x3];                                     // 0x00F1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YLNY[0x7];                                     // 0x0109(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
