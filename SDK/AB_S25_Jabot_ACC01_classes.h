...
// AnimBlueprintGeneratedClass AB_S25_Jabot_ACC01.AB_S25_Jabot_ACC01_C
...
public:
	...
	struct FAnimNode_UseCachedPose                     AnimGraphNode_UseCachedPose_3;                             // 0x0BD0(0x0030)
	struct FAnimNode_ConvertLocalToComponentSpace      AnimGraphNode_LocalToComponentSpace_2;                     // 0x0C00(0x0020)
	...
	unsigned char                                      UnknownData_B4Y2[0x8];                                     // 0x0C78(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FAnimNode_UseCachedPose                     AnimGraphNode_UseCachedPose_2;                             // 0x1560(0x0030)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("AnimBlueprintGeneratedClass AB_S25_Jabot_ACC01.AB_S25_Jabot_ACC01_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_AB_S25_Jabot_ACC01(int EntryPoint);
};
