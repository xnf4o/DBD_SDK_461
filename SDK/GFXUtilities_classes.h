...
public:
	...
	unsigned char                                      UnknownData_BZY3[0x2];                                     // 0x00E2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_S0S8[0x1];                                     // 0x00EF(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZSIA[0x10];                                    // 0x0100(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_LYIV[0x48];                                    // 0x0210(0x0048) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_4ZCC[0x8];                                     // 0x0288(0x0008) Fix Super Size
...
{
public:
	unsigned char                                      UnknownData_XHNO[0x8];                                     // 0x04E8(0x0008) Fix Super Size
...
{
public:
	unsigned char                                      UnknownData_OZ7N[0x8];                                     // 0x0288(0x0008) Fix Super Size
...
{
public:
	unsigned char                                      UnknownData_R7DC[0x40];                                    // 0x0038(0x0040) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_1YPR[0x30];                                    // 0x0040(0x0030) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_HAFX[0x8];                                     // 0x0090(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_E472[0x24];                                    // 0x0054(0x0024) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_Z1CL[0x8];                                     // 0x0328(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_04ZP[0x8];                                     // 0x04E8(0x0008) Fix Super Size
...
{
public:
	unsigned char                                      UnknownData_U2EB[0x4];                                     // 0x0B5C(0x0004) Fix Super Size
...
public:
	...
	unsigned char                                      UnknownData_VQTO[0x7];                                     // 0x0211(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SODV[0x4];                                     // 0x022C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_KXM0[0x8];                                     // 0x0258(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_N9UJ[0x2];                                     // 0x022E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KWAJ[0x8];                                     // 0x0238(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_OGD1[0x8];                                     // 0x0238(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_SYFX[0x8];                                     // 0x0248(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_9KNT[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (PADDING)
