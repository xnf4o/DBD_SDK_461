...
public:
	...
	unsigned char                                      UnknownData_LE52[0x8];                                     // 0x1998(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("AnimBlueprintGeneratedClass AB_US_Necklace_ACC02.AB_US_Necklace_ACC02_C");
		return ptr;
	}
