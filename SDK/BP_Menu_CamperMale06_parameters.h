...
struct UBP_Menu_CamperMale06_C_ReceiveBeginPlay_Params
{
};

// Function BP_Menu_CamperMale06.BP_Menu_CamperMale06_C.ReceiveTick
struct UBP_Menu_CamperMale06_C_ReceiveTick_Params
{
	float                                              deltaSeconds;                                              // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function BP_Menu_CamperMale06.BP_Menu_CamperMale06_C.ExecuteUbergraph_BP_Menu_CamperMale06
struct UBP_Menu_CamperMale06_C_ExecuteUbergraph_BP_Menu_CamperMale06_Params
{
