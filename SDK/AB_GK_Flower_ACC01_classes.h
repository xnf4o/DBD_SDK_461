...
public:
	...
	unsigned char                                      UnknownData_KJW6[0x8];                                     // 0x0848(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2O8K[0x7];                                     // 0x1029(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
