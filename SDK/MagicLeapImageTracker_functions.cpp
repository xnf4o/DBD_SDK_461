...
bool UMagicLeapImageTrackerComponent::SetTargetAsync(class UTexture2D* ImageTarget)
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function MagicLeapImageTracker.MagicLeapImageTrackerComponent.SetTargetAsync");
...
bool UMagicLeapImageTrackerComponent::RemoveTargetAsync()
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function MagicLeapImageTracker.MagicLeapImageTrackerComponent.RemoveTargetAsync");
...
void UMagicLeapImageTrackerFunctionLibrary::STATIC_SetMaxSimultaneousTargets(int MaxSimultaneousTargets)
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function MagicLeapImageTracker.MagicLeapImageTrackerFunctionLibrary.SetMaxSimultaneousTargets");
...
bool UMagicLeapImageTrackerFunctionLibrary::STATIC_IsImageTrackingEnabled()
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function MagicLeapImageTracker.MagicLeapImageTrackerFunctionLibrary.IsImageTrackingEnabled");
...
int UMagicLeapImageTrackerFunctionLibrary::STATIC_GetMaxSimultaneousTargets()
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function MagicLeapImageTracker.MagicLeapImageTrackerFunctionLibrary.GetMaxSimultaneousTargets");
...
void UMagicLeapImageTrackerFunctionLibrary::STATIC_EnableImageTracking(bool bEnable)
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function MagicLeapImageTracker.MagicLeapImageTrackerFunctionLibrary.EnableImageTracking");
