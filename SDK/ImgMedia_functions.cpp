...
void UImgMediaSource::SetSequencePath(const struct FString& path)
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function ImgMedia.ImgMediaSource.SetSequencePath");
...
struct FString UImgMediaSource::GetSequencePath()
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function ImgMedia.ImgMediaSource.GetSequencePath");
...
void UImgMediaSource::GetProxies(TArray<struct FString>* OutProxies)
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function ImgMedia.ImgMediaSource.GetProxies");
