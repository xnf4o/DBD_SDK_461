...
struct FButtonSequenceData : public FTableRowBase
{
	...
	unsigned char                                      UnknownData_3HKA[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_P5FR[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_U8QX[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (PADDING)
