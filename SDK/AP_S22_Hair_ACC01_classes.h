...
// AnimBlueprintGeneratedClass AP_S22_Hair_ACC01.AP_S22_Hair_ACC01_C
...
public:
	...
	unsigned char                                      UnknownData_O5FD[0x8];                                     // 0x1538(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FAnimNode_UseCachedPose                     AnimGraphNode_UseCachedPose_2;                             // 0x26E0(0x0030)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("AnimBlueprintGeneratedClass AP_S22_Hair_ACC01.AP_S22_Hair_ACC01_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_AP_S22_Hair_ACC01(int EntryPoint);
};
