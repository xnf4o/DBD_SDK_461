...
void UTurnBasedMatchInterface::OnMatchReceivedTurn(const struct FString& Match, bool bDidBecomeActive)
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function OnlineSubsystem.TurnBasedMatchInterface.OnMatchReceivedTurn");
...
void UTurnBasedMatchInterface::OnMatchEnded(const struct FString& Match)
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function OnlineSubsystem.TurnBasedMatchInterface.OnMatchEnded");
