...
{
public:
	unsigned char                                      UnknownData_KKQJ[0x10];                                    // 0x00F0(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_CN9Y[0x30];                                    // 0x00D8(0x0030) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_BO3K[0x8];                                     // 0x0628(0x0008) Fix Super Size
	unsigned char                                      UnknownData_3P9S[0x8];                                     // 0x0630(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_JVUS[0x8];                                     // 0x0218(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1V4E[0x4];                                     // 0x0224(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SA00[0x50];                                    // 0x0278(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_MMIL[0x8];                                     // 0x0628(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_6ABW[0x20];                                    // 0x0650(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_8EX0[0x40];                                    // 0x0500(0x0040) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_Z04I[0x4];                                     // 0x024C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_B710[0x7];                                     // 0x0259(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_752U[0x28];                                    // 0x0268(0x0028) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_FERY[0x1C];                                    // 0x00E4(0x001C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_T5FP[0x38];                                    // 0x00C8(0x0038) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_TM60[0x4];                                     // 0x00FC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JMYF[0x20];                                    // 0x0108(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_2LU9[0x80];                                    // 0x00B8(0x0080) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_RZ8O[0x8];                                     // 0x00D8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_MXFR[0x8];                                     // 0x00B8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OG3I[0x34];                                    // 0x00C4(0x0034) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_CLTR[0x28];                                    // 0x02A8(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_KVQZ[0x60];                                    // 0x00C8(0x0060) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_JHFN[0x38];                                    // 0x00B8(0x0038) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_QCNZ[0x34];                                    // 0x0148(0x0034) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XP50[0x53];                                    // 0x017D(0x0053) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_EVW2[0x20];                                    // 0x0500(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_7I3K[0x20];                                    // 0x00B8(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_6ZLL[0x4];                                     // 0x0244(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_WNU1[0x10];                                    // 0x00B8(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_R2BL[0x10];                                    // 0x02E0(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_Q2NY[0x1F];                                    // 0x0271(0x001F) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_SVVX[0x4];                                     // 0x063C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Y7KR[0x28];                                    // 0x0648(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_HSR1[0x20];                                    // 0x02E0(0x0020) MISSED OFFSET (PADDING)
