...
{
public:
	unsigned char                                      UnknownData_B3R9[0x8];                                     // 0x05A8(0x0008) Fix Super Size
...
public:
	...
	unsigned char                                      UnknownData_NWOU[0xF];                                     // 0x04F1(0x000F) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_PH12[0x8];                                     // 0x02A8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VUOU[0xD4];                                    // 0x02B4(0x00D4) MISSED OFFSET (PADDING)
