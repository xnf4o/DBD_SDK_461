...
bool ULocationServices::STATIC_StopLocationServices()
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function LocationServicesBPLibrary.LocationServices.StopLocationServices");
...
bool ULocationServices::STATIC_StartLocationServices()
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function LocationServicesBPLibrary.LocationServices.StartLocationServices");
...
bool ULocationServices::STATIC_IsLocationAccuracyAvailable(LocationServicesBPLibrary_ELocationAccuracy Accuracy)
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function LocationServicesBPLibrary.LocationServices.IsLocationAccuracyAvailable");
...
bool ULocationServices::STATIC_InitLocationServices(LocationServicesBPLibrary_ELocationAccuracy Accuracy, float UpdateFrequency, float MinDistanceFilter)
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function LocationServicesBPLibrary.LocationServices.InitLocationServices");
...
class ULocationServicesImpl* ULocationServices::STATIC_GetLocationServicesImpl()
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function LocationServicesBPLibrary.LocationServices.GetLocationServicesImpl");
...
struct FLocationServicesData ULocationServices::STATIC_GetLastKnownLocation()
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function LocationServicesBPLibrary.LocationServices.GetLastKnownLocation");
...
bool ULocationServices::STATIC_AreLocationServicesEnabled()
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function LocationServicesBPLibrary.LocationServices.AreLocationServicesEnabled");
