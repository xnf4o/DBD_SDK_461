...
struct FMovieSceneMediaSectionParams
{
	...
	unsigned char                                      UnknownData_RAQH[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneMediaPlayerPropertySectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	unsigned char                                      UnknownData_ACY9[0x3];                                     // 0x0065(0x0003) MISSED OFFSET (PADDING)
