...
{
public:
	unsigned char                                      UnknownData_P0CO[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_F1OM[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
