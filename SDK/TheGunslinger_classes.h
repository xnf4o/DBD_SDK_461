...
public:
	...
	unsigned char                                      UnknownData_EMUK[0x18];                                    // 0x0350(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_827W[0x18];                                    // 0x00B8(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_A4I2[0x30];                                    // 0x0100(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_R4JK[0x8];                                     // 0x0168(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DCSJ[0x10];                                    // 0x0178(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_433C[0x8];                                     // 0x0348(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_B46H[0x3];                                     // 0x035D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_989U[0x10];                                    // 0x0370(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_CKIA[0x8];                                     // 0x0520(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_C3HE[0x8];                                     // 0x0768(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_60WB[0xF0];                                    // 0x0850(0x00F0) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_KXPH[0xC];                                     // 0x0348(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QGOJ[0x8];                                     // 0x0390(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_SR1G[0x2];                                     // 0x0356(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EQTH[0x4];                                     // 0x0364(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_F4CN[0x8];                                     // 0x03E8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_R1O5[0x8];                                     // 0x05A8(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_Q35B[0x4];                                     // 0x05BC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1IY8[0x78];                                    // 0x0668(0x0078) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_HBTA[0x4];                                     // 0x00DC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_S4UX[0x68];                                    // 0x00E8(0x0068) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_B09O[0x4];                                     // 0x0104(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2SYB[0x8];                                     // 0x0120(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_N5CQ[0x10];                                    // 0x0130(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_OQCG[0x1];                                     // 0x0513(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZKRI[0x2];                                     // 0x051E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_59MT[0x5A];                                    // 0x0526(0x005A) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_H1QC[0x4];                                     // 0x01D4(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_7NNX[0x78];                                    // 0x02F0(0x0078) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_N9F2[0x8];                                     // 0x03B8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_DAED[0x10];                                    // 0x0250(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_519F[0x18];                                    // 0x0288(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_AFJY[0x8];                                     // 0x0230(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_NBZG[0x18];                                    // 0x0420(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HUW7[0x8];                                     // 0x04D8(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_APY4[0x4];                                     // 0x027C(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_KUUG[0x3];                                     // 0x0219(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VW8K[0x8];                                     // 0x0220(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_RUX4[0x28];                                    // 0x0220(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_LOSZ[0x10];                                    // 0x0188(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_2Y3O[0x30];                                    // 0x00B8(0x0030) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_V6K1[0x4];                                     // 0x0244(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_CYDF[0x60];                                    // 0x0348(0x0060) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DEOH[0x24];                                    // 0x03C4(0x0024) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_ON7R[0x4];                                     // 0x0504(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4KWX[0x4];                                     // 0x050C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CKHI[0x28];                                    // 0x0518(0x0028) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_62AM[0x18];                                    // 0x06C8(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_YSTN[0x188];                                   // 0x0290(0x0188) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_5YBX[0x8];                                     // 0x00B8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5IPL[0x18];                                    // 0x00D0(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YVHT[0x7];                                     // 0x00E9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_V3AQ[0x10];                                    // 0x00F8(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PNUQ[0x7];                                     // 0x01E1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FText                                       _chargeProgressDescriptionText;                            // 0x01E8(0x0018) (Edit, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_KR8B[0x10];                                    // 0x0200(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VJ9M[0x8];                                     // 0x0218(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_S95F[0x3C];                                    // 0x00E4(0x003C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UI7N[0x4];                                     // 0x0198(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CA5I[0x6C];                                    // 0x01A4(0x006C) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_FNWD[0x8];                                     // 0x01B0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_666A[0x4];                                     // 0x0234(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_D7P6[0x4];                                     // 0x0244(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UA0Z[0x10];                                    // 0x0258(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_TRPD[0x30];                                    // 0x0160(0x0030) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_7ZTW[0x4];                                     // 0x0354(0x0004) MISSED OFFSET (PADDING)
