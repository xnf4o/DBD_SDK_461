...
struct FClothConfig_Legacy
{
	...
	unsigned char                                      UnknownData_41Q9[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_25UU[0x3];                                     // 0x00BD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FClothLODDataCommon
{
	...
	unsigned char                                      UnknownData_J7WL[0x20];                                    // 0x0138(0x0020) MISSED OFFSET (PADDING)
...
struct FClothParameterMask_Legacy
{
	...
	unsigned char                                      UnknownData_0CY5[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DVDQ[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
