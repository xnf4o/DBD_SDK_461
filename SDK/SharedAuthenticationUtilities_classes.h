...
public:
	...
	unsigned char                                      UnknownData_Z5RD[0x4];                                     // 0x00BC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TOLU[0x98];                                    // 0x00C8(0x0098) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_X3MW[0x18];                                    // 0x0260(0x0018) MISSED OFFSET (PADDING)
