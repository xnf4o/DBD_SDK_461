...
struct UBP_Menu_CamperMale08_C_ReceiveBeginPlay_Params
{
};

// Function BP_Menu_CamperMale08.BP_Menu_CamperMale08_C.ReceiveTick
struct UBP_Menu_CamperMale08_C_ReceiveTick_Params
{
	float                                              deltaSeconds;                                              // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function BP_Menu_CamperMale08.BP_Menu_CamperMale08_C.ExecuteUbergraph_BP_Menu_CamperMale08
struct UBP_Menu_CamperMale08_C_ExecuteUbergraph_BP_Menu_CamperMale08_Params
{
