...
{
	unsigned char                                      UnknownData_Q5QI[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct Fbox
{
	...
	unsigned char                                      UnknownData_I9L2[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (PADDING)
...
struct FBox2D
{
	...
	unsigned char                                      UnknownData_BW3T[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FInterpCurvePointFloat
{
	...
	unsigned char                                      UnknownData_EP2D[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FInterpCurveFloat
{
	...
	unsigned char                                      UnknownData_O9RY[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInterpCurvePointVector2D
{
	...
	unsigned char                                      UnknownData_8Q3N[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FInterpCurveVector2D
{
	...
	bool                                               bIsLooped;                                                 // 0x0010(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_SGH5[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              LoopKeyOffset;                                             // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FInterpCurvePointVector
{
	...
	unsigned char                                      UnknownData_R104[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (PADDING)
...
struct FInterpCurveVector
{
	...
	bool                                               bIsLooped;                                                 // 0x0010(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_2K4Z[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              LoopKeyOffset;                                             // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
	float                                              InVal;                                                     // 0x0000(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_ACKS[0xC];                                     // 0x0004(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DZPU[0xF];                                     // 0x0041(0x000F) MISSED OFFSET (PADDING)
...
struct FInterpCurveQuat
{
	...
	bool                                               bIsLooped;                                                 // 0x0010(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_I0AB[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              LoopKeyOffset;                                             // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FInterpCurvePointTwoVectors
{
	...
	unsigned char                                      UnknownData_FI6R[0x3];                                     // 0x004D(0x0003) MISSED OFFSET (PADDING)
...
struct FInterpCurveTwoVectors
{
	...
	bool                                               bIsLooped;                                                 // 0x0010(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_AROJ[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              LoopKeyOffset;                                             // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FInterpCurvePointLinearColor
{
	...
	unsigned char                                      UnknownData_M9QY[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (PADDING)
...
struct FInterpCurveLinearColor
{
	...
	bool                                               bIsLooped;                                                 // 0x0010(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_2Q98[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              LoopKeyOffset;                                             // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FTransform
{
	...
	unsigned char                                      UnknownData_9R64[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3SE7[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FTimecode
{
	...
	unsigned char                                      UnknownData_2H0N[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FTimespan
{
	unsigned char                                      UnknownData_AGE5[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FSoftObjectPath
{
	...
	unsigned char                                      UnknownData_ER2D[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_LHDQ[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FFloatRangeBound
{
	...
	unsigned char                                      UnknownData_PLHL[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	TEnumAsByte<CoreUObject_ERangeBoundTypes>          type;                                                      // 0x0000(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_3PJ7[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPolyglotTextData
{
	...
	unsigned char                                      UnknownData_AWDR[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0ZU5[0x7];                                     // 0x0099(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAutomationEvent
{
	...
	unsigned char                                      UnknownData_3XAI[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDateTime
{
	unsigned char                                      UnknownData_HEZD[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FAutomationExecutionEntry
{
	...
	unsigned char                                      UnknownData_LCW1[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
