...
public:
	...
	unsigned char                                      UnknownData_8DS9[0x3];                                     // 0x0235(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NJ0Z[0x4];                                     // 0x023C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WEOF[0x20];                                    // 0x0260(0x0020) MISSED OFFSET (PADDING)
