...
{
public:
	unsigned char                                      UnknownData_KHRM[0x8];                                     // 0x00B8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_X57R[0x14];                                    // 0x00C4(0x0014) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_66ML[0x78];                                    // 0x0230(0x0078) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_JHTW[0x50];                                    // 0x00B8(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_LRTA[0x8];                                     // 0x00B8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_TYAO[0x60];                                    // 0x00B8(0x0060) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_G53C[0xC];                                     // 0x012C(0x000C) MISSED OFFSET (PADDING)
