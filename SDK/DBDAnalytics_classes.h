...
{
public:
	unsigned char                                      UnknownData_6IWK[0x2538];                                  // 0x0038(0x2538) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_OMDL[0xB8];                                    // 0x00B8(0x00B8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_421G[0x88];                                    // 0x00B8(0x0088) MISSED OFFSET (PADDING)
