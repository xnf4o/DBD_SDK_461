...
{
	unsigned char                                      UnknownData_4RO8[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FAnimationMontageDescriptor
{
	...
	unsigned char                                      UnknownData_R1ZC[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FmontageStopDefinition
{
	...
	unsigned char                                      UnknownData_0CO8[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FTaggedAnimCollection
{
	...
	unsigned char                                      UnknownData_VDU4[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FmontagePlaybackDefinition
{
	...
	unsigned char                                      UnknownData_IYXY[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (PADDING)
