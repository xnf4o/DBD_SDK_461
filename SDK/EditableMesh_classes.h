...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class EditableMesh.EditableMeshAdapter");
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_YF6W[0x9C];                                    // 0x0044(0x009C) MISSED OFFSET (PADDING)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class EditableMesh.EditableGeometryCollectionAdapter");
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_WC7W[0x390];                                   // 0x0030(0x0390) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<class UEditableMeshAdapter*>                Adapters;                                                  // 0x03C0(0x0010) (ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_8YG7[0x8];                                     // 0x03D0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_A74G[0x148];                                   // 0x03DC(0x0148) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MA6M[0x1E4];                                   // 0x052C(0x01E4) MISSED OFFSET (PADDING)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class EditableMesh.EditableMesh");
		return ptr;
	}
...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class EditableMesh.EditableMeshFactory");
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_Z024[0xA4];                                    // 0x0044(0x00A4) MISSED OFFSET (PADDING)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class EditableMesh.EditableStaticMeshAdapter");
		return ptr;
	}
