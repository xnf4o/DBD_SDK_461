...
public:
	...
	unsigned char                                      UnknownData_5GB5[0x68];                                    // 0x0128(0x0068) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_DX8D[0x8];                                     // 0x05A8(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_G270[0xC];                                     // 0x0644(0x000C) MISSED OFFSET (PADDING)
