...
{
public:
	unsigned char                                      UnknownData_V1V2[0x20];                                    // 0x0100(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_A5RG[0x8];                                     // 0x0350(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FTagStateBool                               _isInTantrum;                                              // 0x0358(0x0030) (Transient, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_P7V1[0x28];                                    // 0x0388(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_T3MQ[0x18];                                    // 0x0128(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_2ZLW[0x10];                                    // 0x00E0(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_UTY7[0x28];                                    // 0x0118(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_EFBY[0x8];                                     // 0x00B8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XG1W[0xC8];                                    // 0x00D8(0x00C8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HAU8[0x8];                                     // 0x01D8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_CA20[0x90];                                    // 0x0690(0x0090) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_Z2CM[0x10];                                    // 0x0228(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_IA03[0x10];                                    // 0x0228(0x0010) MISSED OFFSET (PADDING)
