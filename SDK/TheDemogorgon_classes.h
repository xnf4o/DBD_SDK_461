...
{
public:
	unsigned char                                      UnknownData_U9W2[0x80];                                    // 0x02E0(0x0080) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_62VJ[0x8];                                     // 0x0628(0x0008) Fix Super Size
	unsigned char                                      UnknownData_WHN4[0x68];                                    // 0x0630(0x0068) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4RJE[0x38];                                    // 0x06A8(0x0038) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_RFJC[0x40];                                    // 0x04F0(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1LXN[0xD];                                     // 0x0533(0x000D) MISSED OFFSET (PADDING)
