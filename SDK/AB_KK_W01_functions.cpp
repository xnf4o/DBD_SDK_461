...
void UAB_KK_W01_C::AnimGraph(struct FPoseLink* AnimGraph)
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function AB_KK_W01.AB_KK_W01_C.AnimGraph");
...
bool UAB_KK_W01_C::GetLegionAttack()
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function AB_KK_W01.AB_KK_W01_C.GetLegionAttack");
...
void UAB_KK_W01_C::BlueprintUpdateAnimation(float DeltaTimeX)
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function AB_KK_W01.AB_KK_W01_C.BlueprintUpdateAnimation");
...
void UAB_KK_W01_C::ExecuteUbergraph_AB_KK_W01(int EntryPoint)
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function AB_KK_W01.AB_KK_W01_C.ExecuteUbergraph_AB_KK_W01");
