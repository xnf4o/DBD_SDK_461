...
{
public:
	unsigned char                                      UnknownData_VTFA[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_JZBH[0x18];                                    // 0x0030(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EMZN[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_Q1D3[0x20];                                    // 0x0030(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZH46[0x20];                                    // 0x0068(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_XYD6[0x8];                                     // 0x0088(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_7ZXD[0x10];                                    // 0x0088(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_XNKJ[0x8];                                     // 0x0088(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_AFDB[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_4ET5[0x38];                                    // 0x0090(0x0038) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_7XM2[0x3];                                     // 0x00D1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FBrushStampData                             LastBrushStamp;                                            // 0x00D4(0x00B0) (NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_CZBM[0x14];                                    // 0x0184(0x0014) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_OU4P[0x3];                                     // 0x005D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_K7PP[0x2];                                     // 0x006E(0x0002) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_GV4K[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_0T91[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_9WX8[0x48];                                    // 0x0038(0x0048) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_33G2[0x10];                                    // 0x0040(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JRI5[0x3];                                     // 0x0091(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XH71[0x14];                                    // 0x00E4(0x0014) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_5L9U[0x10];                                    // 0x0040(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TScriptInterface<class UGizmoAxisSource>           AxisSource;                                                // 0x0050(0x0010) (ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_NK78[0x2];                                     // 0x0092(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ON5A[0x10];                                    // 0x00D0(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_87DU[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_LUKJ[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct Fvector                                     origin;                                                    // 0x0038(0x000C) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct Fvector                                     direction;                                                 // 0x0044(0x000C) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	unsigned char                                      UnknownData_3Z74[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct Fvector                                     origin;                                                    // 0x0038(0x000C) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	unsigned char                                      UnknownData_L8FG[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_X31E[0x3];                                     // 0x0045(0x0003) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_SQFC[0x1];                                     // 0x0063(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_M9M6[0x2];                                     // 0x007E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EQDB[0x4];                                     // 0x0094(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_U6CL[0x18];                                    // 0x00A0(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_LMRE[0xA0];                                    // 0x0080(0x00A0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4V8J[0x1F];                                    // 0x0121(0x001F) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_D8CK[0x140];                                   // 0x0140(0x0140) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_9T82[0x8];                                     // 0x0088(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_SFOE[0x8];                                     // 0x0440(0x0008) Fix Super Size
...
public:
	...
	unsigned char                                      UnknownData_RHBT[0x10];                                    // 0x0460(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_L141[0xC];                                     // 0x0454(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RPLH[0xE];                                     // 0x0482(0x000E) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_C5RW[0xE];                                     // 0x0462(0x000E) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_TXCT[0x90];                                    // 0x0030(0x0090) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_R2K1[0x30];                                    // 0x0030(0x0030) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_UO5X[0x28];                                    // 0x0030(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6OE6[0x88];                                    // 0x0068(0x0088) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_0E5I[0x90];                                    // 0x0030(0x0090) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_AUC7[0x8];                                     // 0x0040(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5XLU[0x2];                                     // 0x0052(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2H8R[0x3];                                     // 0x0052(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData_Q80S[0x98];                                    // 0x0058(0x0098) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_THJ9[0x10];                                    // 0x0120(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QWAO[0x18];                                    // 0x0178(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_X7VR[0x48];                                    // 0x0030(0x0048) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0JAU[0x16];                                    // 0x007A(0x0016) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_6UBE[0x20];                                    // 0x0030(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_LLPC[0x7];                                     // 0x0059(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_2TCA[0x80];                                    // 0x0060(0x0080) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_K966[0x3];                                     // 0x046D(0x0003) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_PMO0[0xB];                                     // 0x0475(0x000B) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_XIPS[0x90];                                    // 0x0030(0x0090) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_GW88[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BAIN[0x40];                                    // 0x0040(0x0040) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_E9EA[0xE];                                     // 0x0032(0x000E) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4NYE[0x70];                                    // 0x0048(0x0070) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_UZFN[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_K343[0x18];                                    // 0x0048(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TMap<struct FString, class UInteractiveGizmoBuilder*> GizmoBuilders;                                             // 0x0060(0x0050) (Protected, NativeAccessSpecifierProtected)
	unsigned char                                      UnknownData_0A4C[0x10];                                    // 0x00B0(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_41GM[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_M4AL[0x50];                                    // 0x0048(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TMap<struct FString, class UInteractiveToolBuilder*> ToolBuilders;                                              // 0x0098(0x0050) (Protected, NativeAccessSpecifierProtected)
	unsigned char                                      UnknownData_INQH[0x58];                                    // 0x00E8(0x0058) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_6K00[0x30];                                    // 0x0030(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_5S4K[0x90];                                    // 0x0030(0x0090) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_JEGR[0x10];                                    // 0x0048(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SV5A[0x18];                                    // 0x0080(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7UK5[0x98];                                    // 0x00A8(0x0098) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_OY50[0x20];                                    // 0x0030(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_ZA1M[0xF8];                                    // 0x0038(0x00F8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_BEUH[0x68];                                    // 0x0038(0x0068) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_JHPW[0xB0];                                    // 0x0080(0x00B0) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_S9FU[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_E0M4[0x20];                                    // 0x0030(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_GUZJ[0x40];                                    // 0x0050(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_R3DY[0xC];                                     // 0x00D4(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_6UNK[0x40];                                    // 0x0050(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TScriptInterface<class UGizmoAxisSource>           AxisSource;                                                // 0x0090(0x0010) (ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, NativeAccessSpecifierPublic)
	TScriptInterface<class UGizmoTransformSource>      TransformSource;                                           // 0x00A0(0x0010) (ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_TVUK[0x8];                                     // 0x00F8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_UWOC[0xC];                                     // 0x0094(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_Q277[0x4];                                     // 0x00BC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	struct Fvector                                     CurScaleOrigin;                                            // 0x008C(0x000C) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_7IET[0x8];                                     // 0x0098(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FTransform                                  InitialTransform;                                          // 0x00A0(0x0030) (IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
{
public:
	unsigned char                                      UnknownData_PP1J[0x40];                                    // 0x0050(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TScriptInterface<class UGizmoAxisSource>           AxisSource;                                                // 0x0090(0x0010) (ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, NativeAccessSpecifierPublic)
	TScriptInterface<class UGizmoTransformSource>      TransformSource;                                           // 0x00A0(0x0010) (ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_GKHV[0x4];                                     // 0x00FC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FTransform                                  InitialTransform;                                          // 0x0100(0x0030) (IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
{
public:
	unsigned char                                      UnknownData_ISMD[0x10];                                    // 0x0040(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TScriptInterface<class UGizmoAxisSource>           AxisSource;                                                // 0x0050(0x0010) (ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_0CYZ[0x14];                                    // 0x00F4(0x0014) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_S4AM[0x18];                                    // 0x0030(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_8ILV[0x40];                                    // 0x0080(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7XIA[0x6F];                                    // 0x00C1(0x006F) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_4VUW[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (PADDING)
