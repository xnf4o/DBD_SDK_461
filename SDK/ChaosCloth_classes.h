...
public:
	...
	unsigned char                                      UnknownData_JW57[0x3];                                     // 0x0041(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CF77[0x3];                                     // 0x0049(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1DLT[0x2];                                     // 0x005E(0x0002) MISSED OFFSET (PADDING)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class ChaosCloth.ChaosClothSharedSimConfig");
		return ptr;
	}
...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class ChaosCloth.ChaosClothingSimulationFactory");
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_M8SU[0x10];                                    // 0x0038(0x0010) MISSED OFFSET (PADDING)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class ChaosCloth.ChaosClothingSimulationInteractor");
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_1ETX[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_93HI[0x3];                                     // 0x005D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OOGG[0x3];                                     // 0x007D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class ChaosCloth.ChaosClothConfig");
		return ptr;
	}
