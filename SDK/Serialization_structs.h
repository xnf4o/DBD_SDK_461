...
struct FStructSerializerBuiltinTestStruct
{
	...
	unsigned char                                      UnknownData_QD3Q[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UKUQ[0xC];                                     // 0x0054(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NHI0[0x4];                                     // 0x007C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NZ9E[0xC];                                     // 0x0094(0x000C) MISSED OFFSET (PADDING)
...
struct FStructSerializerByteArray
{
	...
	unsigned char                                      UnknownData_0KDR[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_R5WK[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
struct FStructSerializerNumericTestStruct
{
	...
	unsigned char                                      UnknownData_MBVN[0x1];                                     // 0x0001(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4SQZ[0x1];                                     // 0x0011(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_A14B[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FStructSerializerArrayTestStruct
{
	...
	unsigned char                                      UnknownData_ULZE[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FStructSerializerTestStruct
{
	...
	unsigned char                                      UnknownData_LGR7[0x5];                                     // 0x0033(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FStructSerializerObjectTestStruct           Objects;                                                   // 0x0038(0x00C0) (NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_QPAI[0x8];                                     // 0x00F8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
