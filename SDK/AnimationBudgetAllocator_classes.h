...
{
public:
	unsigned char                                      UnknownData_AOV7[0x4];                                     // 0x0B5C(0x0004) Fix Super Size
	unsigned char                                      UnknownData_F7JK[0x18];                                    // 0x0B60(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_L7MS[0x7];                                     // 0x0B79(0x0007) MISSED OFFSET (PADDING)
