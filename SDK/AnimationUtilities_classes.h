...
{
public:
	unsigned char                                      UnknownData_XOY8[0x10];                                    // 0x0270(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_R6CE[0x50];                                    // 0x0030(0x0050) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_KSEI[0x3];                                     // 0x0235(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OSN3[0x30];                                    // 0x0240(0x0030) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_64E7[0x54];                                    // 0x02AC(0x0054) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_MAGY[0x10];                                    // 0x00D0(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_QS9K[0xB0];                                    // 0x00B8(0x00B0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_B5S5[0x2];                                     // 0x0176(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JPZX[0x4];                                     // 0x017C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PCJM[0x8];                                     // 0x0188(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FYG9[0x34];                                    // 0x019C(0x0034) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_L1MV[0x4];                                     // 0x01F4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_Z1OV[0x4];                                     // 0x01DC(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_2FAW[0x48];                                    // 0x00B8(0x0048) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_XI20[0x8];                                     // 0x0278(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_VR5R[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (PADDING)
