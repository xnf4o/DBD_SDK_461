...
struct FGhostStatusData
{
	...
	unsigned char                                      UnknownData_Q2UE[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FbaseLoadoutPartViewData
{
	...
	unsigned char                                      UnknownData_HLZ8[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_10IB[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
...
struct FpowerViewData : public FbaseLoadoutPartViewData
{
	...
	unsigned char                                      UnknownData_3903[0x2];                                     // 0x0052(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9F0N[0x2];                                     // 0x005E(0x0002) MISSED OFFSET (PADDING)
...
struct FaddonViewData : public FbaseLoadoutPartViewData
{
	...
	unsigned char                                      UnknownData_X1B1[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (PADDING)
...
struct FScreenIndicatorViewData
{
	...
	unsigned char                                      UnknownData_12HC[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KW74[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FSkillCheckViewData
{
	...
	unsigned char                                      UnknownData_H4GB[0x2];                                     // 0x002E(0x0002) MISSED OFFSET (PADDING)
...
struct FStartSequenceViewData
{
	...
	unsigned char                                      UnknownData_U2GO[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FTallyTutorialPopupViewData
{
	...
	unsigned char                                      UnknownData_12N7[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_7I5S[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FperkViewData : public FbaseLoadoutPartViewData
{
	...
	unsigned char                                      UnknownData_Z22Z[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FitemViewData : public FbaseLoadoutPartViewData
{
	...
	unsigned char                                      UnknownData_ZH02[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CJ9P[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_J8H9[0x7];                                     // 0x0061(0x0007) MISSED OFFSET (PADDING)
...
struct FStatusEffectAlertViewData
{
	...
	unsigned char                                      UnknownData_TF1N[0x6];                                     // 0x001A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FScoreAlertViewData
{
	...
	unsigned char                                      UnknownData_NA3F[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FhudObjectiveViewData
{
	...
	unsigned char                                      UnknownData_WCT6[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FStatusEffectViewData
{
	...
	unsigned char                                      UnknownData_VFMC[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class UTexture2D*                                  IconTexture;                                               // 0x0010(0x0008) (Edit, BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	DBDSharedTypes_EStatusEffectType                   StatusEffectType;                                          // 0x0018(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_5E2T[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6NJ1[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FInteractionProgressViewData
{
	...
	unsigned char                                      UnknownData_P32G[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	struct FName                                       Id;                                                        // 0x0000(0x000C) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_OKNN[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3YRQ[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RNC2[0x7];                                     // 0x0069(0x0007) MISSED OFFSET (PADDING)
...
struct FMatchResultViewData
{
	...
	unsigned char                                      UnknownData_ZW9M[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FofferingViewData : public FbaseLoadoutPartViewData
{
	...
	unsigned char                                      UnknownData_VDMJ[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (PADDING)
...
struct FNightmareStatusData
{
	...
	unsigned char                                      UnknownData_GCU0[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPigStatusData
{
	...
	unsigned char                                      UnknownData_P8R1[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPlagueStatusData
{
	...
	unsigned char                                      UnknownData_ANFA[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FTricksterStatusData
{
	...
	unsigned char                                      UnknownData_HOFH[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (PADDING)
...
struct FPlayerStatusViewData
{
	...
	unsigned char                                      UnknownData_JJQ4[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WV8N[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZVOG[0x3];                                     // 0x0051(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
