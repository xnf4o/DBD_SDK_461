...
{
public:
	unsigned char                                      UnknownData_YROM[0x8];                                     // 0x0230(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_V6OS[0x4];                                     // 0x024C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7JS6[0x4];                                     // 0x0284(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_ITHG[0x8];                                     // 0x0890(0x0008) MISSED OFFSET (PADDING)
