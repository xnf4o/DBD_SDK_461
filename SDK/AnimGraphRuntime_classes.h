...
public:
	...
	unsigned char                                      UnknownData_G870[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_WAIU[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_A8LC[0x10];                                    // 0x0270(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_63FO[0x30];                                    // 0x0080(0x0030) MISSED OFFSET (PADDING)
