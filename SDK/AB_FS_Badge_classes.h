...
public:
	...
	unsigned char                                      UnknownData_OHDQ[0x8];                                     // 0x10D8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("AnimBlueprintGeneratedClass AB_FS_Badge.AB_FS_Badge_C");
		return ptr;
	}
