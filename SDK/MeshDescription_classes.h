...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class MeshDescription.MeshDescription");
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_LOWR[0x368];                                   // 0x0030(0x0368) MISSED OFFSET (PADDING)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class MeshDescription.MeshDescriptionBase");
		return ptr;
	}
