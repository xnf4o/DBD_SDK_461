...
public:
	...
	unsigned char                                      UnknownData_RWWY[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_MH1Q[0x18];                                    // 0x0040(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZW46[0x20];                                    // 0x0060(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_D11U[0x88];                                    // 0x0088(0x0088) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_UZDQ[0x70];                                    // 0x0110(0x0070) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_W5AC[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RYG9[0x3];                                     // 0x00C1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6X2M[0x3];                                     // 0x00CD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UTDJ[0x3];                                     // 0x00CD(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData_7O05[0xC];                                     // 0x00D4(0x000C) MISSED OFFSET (PADDING)
