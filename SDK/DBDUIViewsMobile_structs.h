...
{
	unsigned char                                      UnknownData_BRNS[0x68];                                    // 0x0000(0x0068) MISSED OFFSET (PADDING)
...
struct FactionOnFriend
{
	...
	unsigned char                                      UnknownData_FQ15[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFriendStatusUIData : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_0FDU[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
