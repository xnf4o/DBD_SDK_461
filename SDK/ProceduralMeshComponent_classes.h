...
{
public:
	unsigned char                                      UnknownData_7TP7[0x8];                                     // 0x0478(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_WBRL[0x6];                                     // 0x0482(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6RRW[0x4];                                     // 0x04CC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
