...
{
public:
	unsigned char                                      UnknownData_GYCJ[0x50];                                    // 0x0030(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_2CXF[0x18];                                    // 0x0038(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4GON[0x38];                                    // 0x0068(0x0038) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_CIDU[0x20];                                    // 0x0038(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_LOLE[0x20];                                    // 0x0030(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_PCMY[0x38];                                    // 0x0038(0x0038) MISSED OFFSET (PADDING)
