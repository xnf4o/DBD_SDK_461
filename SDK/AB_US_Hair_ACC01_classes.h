...
// AnimBlueprintGeneratedClass AB_US_Hair_ACC01.AB_US_Hair_ACC01_C
...
public:
	...
	unsigned char                                      UnknownData_C21X[0x8];                                     // 0x1998(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("AnimBlueprintGeneratedClass AB_US_Hair_ACC01.AB_US_Hair_ACC01_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_AB_US_Hair_ACC01(int EntryPoint);
};
