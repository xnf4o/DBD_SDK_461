...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class FieldSystemEngine.FieldNodeBase");
		return ptr;
	}
...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class FieldSystemEngine.FieldNodeFloat");
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_V069[0x4];                                     // 0x00BC(0x0004) MISSED OFFSET (PADDING)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class FieldSystemEngine.UniformScalar");
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_ZGTN[0x7];                                     // 0x00D9(0x0007) MISSED OFFSET (PADDING)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class FieldSystemEngine.RadialFalloff");
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_CPNQ[0x3];                                     // 0x00E5(0x0003) MISSED OFFSET (PADDING)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class FieldSystemEngine.PlaneFalloff");
		return ptr;
	}
...
public:
	...
	float                                              MaxRange;                                                  // 0x00C0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                              Default;                                                   // 0x00C4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_N5WU[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_002Q[0xF];                                     // 0x0101(0x000F) MISSED OFFSET (PADDING)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class FieldSystemEngine.BoxFalloff");
		return ptr;
	}
...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class FieldSystemEngine.NoiseField");
		return ptr;
	}
...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class FieldSystemEngine.FieldNodeVector");
		return ptr;
	}
...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class FieldSystemEngine.UniformVector");
		return ptr;
	}
...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class FieldSystemEngine.RadialVector");
		return ptr;
	}
...
public:
	float                                              Magnitude;                                                 // 0x00B8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_H4UC[0x4];                                     // 0x00BC(0x0004) MISSED OFFSET (PADDING)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class FieldSystemEngine.RandomVector");
		return ptr;
	}
...
public:
	float                                              Magnitude;                                                 // 0x00B8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_XJYS[0x4];                                     // 0x00BC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7D5O[0x7];                                     // 0x00D1(0x0007) MISSED OFFSET (PADDING)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class FieldSystemEngine.OperatorField");
		return ptr;
	}
...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class FieldSystemEngine.FieldNodeInt");
		return ptr;
	}
...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class FieldSystemEngine.ToIntegerField");
		return ptr;
	}
...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class FieldSystemEngine.ToFloatField");
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_R3HW[0x7];                                     // 0x00C9(0x0007) MISSED OFFSET (PADDING)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class FieldSystemEngine.CullingField");
		return ptr;
	}
...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class FieldSystemEngine.ReturnResultsTerminal");
		return ptr;
	}
...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class FieldSystemEngine.FieldSystemActor");
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_OC3U[0x10];                                    // 0x0030(0x0010) MISSED OFFSET (PADDING)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class FieldSystemEngine.FieldSystem");
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_FXF1[0x10];                                    // 0x0430(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      SupportedSolvers[0x10];                                    // 0x0430(0x0010) UNKNOWN PROPERTY: ArrayProperty
	unsigned char                                      UnknownData_O4J8[0x20];                                    // 0x0450(0x0020) MISSED OFFSET (PADDING)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class FieldSystemEngine.FieldSystemComponent");
		return ptr;
	}
...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class FieldSystemEngine.FieldSystemMetaData");
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_VUWQ[0x4];                                     // 0x00BC(0x0004) MISSED OFFSET (PADDING)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class FieldSystemEngine.FieldSystemMetaDataIteration");
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_R5E0[0x7];                                     // 0x00B9(0x0007) MISSED OFFSET (PADDING)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class FieldSystemEngine.FieldSystemMetaDataProcessingResolution");
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_YDQ7[0x4];                                     // 0x00BC(0x0004) MISSED OFFSET (PADDING)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class FieldSystemEngine.UniformInteger");
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_09D0[0x7];                                     // 0x00D1(0x0007) MISSED OFFSET (PADDING)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class FieldSystemEngine.RadialIntMask");
		return ptr;
	}
